...
public class ServicesController {
    ...
    @GetMapping("/{id}/oncall")
    public ResponseEntity<OnCallEngineerDTO> getCurrentOnCall(@PathVariable UUID id) {
        OnCallEngineerDTO engineer = onCallScheduleService.getCurrentOnCallEngineer(id);
